...
router.post("/filter-products",islogedin,authorize(AuthRoles.ADMIN,AuthRoles.USER),getProductbyCollectionId)
//delete the product
router.delete("/:id",islogedin,authorize(AuthRoles.ADMIN,AuthRoles.MODERATOR),deleteProduct)
//check all products
router.get("/",islogedin,authorize(AuthRoles.ADMIN,AuthRoles.USER),getAllProducts)
//product by id
router.get("/:id",islogedin,authorize(AuthRoles.ADMIN,AuthRoles.MODERATOR,AuthRoles.USER),getProductById)
